  ...
  return (
    <Disclosure as="nav">
        {({ open }) => (
            ...
            className="bg-gray-800 text-white rounded-xl px-5 py-3 hover:bg-gray-900 active:bg-gray-600 hidden sm:flex" 
            />

            <Disclosure.Button 
            className="rounded-md p-2 text-gray-500 hover:bg-gray-700 hover:text-white sm:hidden">
            {open ? (
